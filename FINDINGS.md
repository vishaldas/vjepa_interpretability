...
## F13. The linear path is 80–117× further off-manifold — for **all three** variables
...
Ten errors were found and fixed during the work, four of which changed a published result.
They are logged separately in **[CORRECTIONS.md](CORRECTIONS.md)** — including what each one
changed, and how it was caught.

Findings above name the correction that touched them (C1 … C10).
